...
EXAMPLE_PROMPTS = [
    ("🦐 ดีลกุ้งแชบ๊วยตัวใหญ่", "กุ้งแชบ๊วยตัวใหญ่วันนี้ร้านไหนดีลดีที่สุด?"),
    ("📊 ราคาปลากะพง 7 วัน", "ราคาปลากะพงย้อนหลัง 7 วันเป็นอย่างไร?"),
    ("🦀 เทียบราคาปูม้าเบอร์เล็ก", "เปรียบเทียบราคาปูม้าเบอร์เล็กทุกร้าน"),
    ("🦑 ปลาหมึกกล้วยถูกสุด", "ปลาหมึกกล้วยตัวเล็กร้านไหนถูกที่สุดวันนี้?"),
]
